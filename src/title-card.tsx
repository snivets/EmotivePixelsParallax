...
const TitleCard = () => {
  return (
    <motion.div
      className="full-page"
      style={{ backgroundColor: 'gray', backgroundImage: 'url(src/images/epbg.png)', backgroundSize: 'cover', backgroundPositionY: 'center', height: '100vh'}}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
      <div className="flex justify-center pt-12">
        <img src="./src/images/eplogo.png" alt="Emotive Pixels" />
      </div>
